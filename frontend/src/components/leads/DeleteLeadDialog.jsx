    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
      ...
      <div className="relative bg-white rounded-xl shadow-xl p-6 w-full max-w-md z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h2 className="text-xl font-semibold text-slate-800 mb-2">Remove Prospect</h2>
          <p className="text-slate-600 mb-6">
            Are you sure you want to remove <span className="font-semibold text-slate-800">{leadName}</span>? This action cannot be undone.
          </p>
