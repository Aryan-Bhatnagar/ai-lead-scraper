...
export default function IntelligencePanel({ prospect }) {
  ...
  // We keep the legacy logic as a fallback or side-by-side comparison
  ...
  return (
    <div className="space-y-6 mb-6">
      ...
      <AIInsightsPanel leadId={prospect.id} />

      {/* Legacy Heuristic Intelligence (Fallback/Complementary) */}
      <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-slate-500">Rule-based sales potential analysis</p>
          </div>
