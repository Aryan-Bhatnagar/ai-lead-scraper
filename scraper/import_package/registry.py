                    ...
                    if "place_id" in first or "formatted_address" in first:
                        for adapter in adapters:
                            if adapter.source_name == "Google Maps":
                                return adapter
                    # Check for Google Places format (title, categoryName, placeId)
                    if "placeId" in first or ("title" in first and "categoryName" in first):
                        for adapter in adapters:
                            if adapter.source_name == "Google Places":
                                return adapter
